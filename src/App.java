...
public class App {
    public static void main(String[] args){
        ...
        System.out.println(fsmtable+"what is the start states for your machine?");
        start = scan.nextInt();
        ...
        do{
            ...
            for(char c : test.toCharArray())
            {
                   ...
                   for (int j=0; j<fsmtable.get(current_state).inputs.size(); j++)
                   {
                       ...
                       {
                            T++;
                            System.out.println(T+") Form S"+current_state+"to S"+fsmtable.get(current_state).inputs.get(j).nex_state);
